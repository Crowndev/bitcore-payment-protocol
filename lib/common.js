...
PaymentProtocol.LEGACY_PAYMENT.CRW.REQUEST_CONTENT_TYPE = 'application/crown-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.CRW.CONTENT_TYPE = 'application/crown-payment';
PaymentProtocol.LEGACY_PAYMENT.CRW.ACK_CONTENT_TYPE = 'application/crown-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'CRW';
  this.setObj(obj);
  return this;
};
